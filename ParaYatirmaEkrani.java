...
public class ParaYatirmaEkrani extends javax.swing.JFrame implements IDuzenleyici,IBilgiController {
    ...
    private void initComponents() {
        ...
        setTitle("Swing Bank Para Yatırma Ekranı");

        paraYatirmaEkraniPanel.setBackground(new java.awt.Color(0, 102, 0));
        ...
        limitUyariLabel.setText("Tek seferde 10.000 TL ve altını yatırabilirsiniz.");
    ...
    private void yatirilacakMiktarTextKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_yatirilacakMiktarTextKeyReleased
        this.yatirilacakMiktar = TextAyarlari.checkTheTextKeyReleased(yatirilacakMiktarText, 10000);
