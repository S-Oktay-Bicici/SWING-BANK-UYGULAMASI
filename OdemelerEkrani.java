...
public class OdemelerEkrani extends javax.swing.JFrame implements IDuzenleyici, IBilgiController {
    ...
    private void initComponents() {
        ...
        setTitle("Swing Bank Ödemeler Ekranı");

        odemelerEkraniPanel.setBackground(new java.awt.Color(0, 102, 0));
        ...
        elektrikOdeButton.setBackground(new java.awt.Color(0, 102, 0));
        elektrikOdeButton.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        elektrikOdeButton.setForeground(new java.awt.Color(102, 0, 0));
        ...
        suOdeButton.setBackground(new java.awt.Color(0, 102, 0));
        suOdeButton.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        suOdeButton.setForeground(new java.awt.Color(102, 0, 0));
        ...
        dogalgazOdeButton.setBackground(new java.awt.Color(0, 102, 0));
        dogalgazOdeButton.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        dogalgazOdeButton.setForeground(new java.awt.Color(102, 0, 0));
        ...
        internetOdeButton.setBackground(new java.awt.Color(0, 102, 0));
        internetOdeButton.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        internetOdeButton.setForeground(new java.awt.Color(102, 0, 0));
