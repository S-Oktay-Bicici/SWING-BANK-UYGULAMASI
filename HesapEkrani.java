...
public class HesapEkrani extends javax.swing.JFrame implements IDuzenleyici, IBilgiController {
    ...
    private void initComponents() {
        ...
        setTitle("Swing Bank Hesap Ekranı");

        hesapEkraniPanel.setBackground(new java.awt.Color(0, 102, 0));

        hosgeldinLabel.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        hosgeldinLabel.setForeground(new java.awt.Color(102, 0, 0));
        ...
        kullaniciAdSoyadLabel.setForeground(new java.awt.Color(102, 0, 0));
        ...
        paraCekButton.setBackground(new java.awt.Color(0, 102, 0));
        paraCekButton.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        paraCekButton.setForeground(new java.awt.Color(102, 0, 0));
        ...
        paraYatirButton.setBackground(new java.awt.Color(0, 102, 0));
        paraYatirButton.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        paraYatirButton.setForeground(new java.awt.Color(102, 0, 0));
        ...
        odemelerButton.setBackground(new java.awt.Color(0, 102, 0));
        odemelerButton.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        odemelerButton.setForeground(new java.awt.Color(102, 0, 0));
