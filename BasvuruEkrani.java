...
public class BasvuruEkrani extends javax.swing.JFrame implements IDuzenleyici, IBilgiController {
    ...
    private void initComponents() {
        ...
        setTitle("Swing Bank Başvuru Ekranı");

        basvuruEkraniPanel.setBackground(new java.awt.Color(0, 102, 0));
        basvuruEkraniPanel.setForeground(new java.awt.Color(0, 102, 0));

        kisiselBilgilerLabel.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        kisiselBilgilerLabel.setForeground(new java.awt.Color(102, 0, 0));
        ...
        guvenlikBilgileriLabel.setForeground(new java.awt.Color(102, 0, 0));
        ...
        guvenlikSorusu.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Evcil hayvanınızın adı nedir?", "En sevdiğiniz şehir hangisidir?", "İlkokul öğretmeninizin adı nedir?", "Yaşamak istediğiniz ülke neresidir?", "Ya da rastgele cümle girin(önerilir)." }));
        ...
        basvurButton.setBackground(new java.awt.Color(0, 102, 0));
        basvurButton.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        basvurButton.setForeground(new java.awt.Color(102, 0, 0));
