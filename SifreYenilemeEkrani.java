...
public class SifreYenilemeEkrani extends javax.swing.JFrame implements IDuzenleyici,IBilgiController {
    ...
    private void initComponents() {
        ...
        setTitle("Swing Bank Şifre Yenileme Ekranı");

        sifreYenilemePanel.setBackground(new java.awt.Color(0, 102, 0));
        ...
        sifreYenilemeLabel.setForeground(new java.awt.Color(102, 0, 0));
        ...
        sifreyiYenileButton.setBackground(new java.awt.Color(0, 102, 0));
        sifreyiYenileButton.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        sifreyiYenileButton.setForeground(new java.awt.Color(102, 0, 0));
