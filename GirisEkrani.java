...
public final class GirisEkrani extends javax.swing.JFrame implements IDuzenleyici,IBilgiController {
    ...
    private void initComponents() {
        ...
        setTitle("Swing Bank Giriş Ekranı");
        setResizable(false);

        girisEkraniPanel.setBackground(new java.awt.Color(0, 102, 0));

        hosgeldinizLabel.setFont(new java.awt.Font("Tahoma", 1, 22)); // NOI18N
        hosgeldinizLabel.setForeground(new java.awt.Color(102, 0, 0));
        ...
        girisButton.setBackground(new java.awt.Color(0, 102, 0));
        girisButton.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        girisButton.setForeground(new java.awt.Color(102, 0, 0));
        ...
        soruLabel.setForeground(new java.awt.Color(0, 0, 102));
        soruLabel.setText("Müşterimiz değil misiniz?");

        basvurButton.setBackground(new java.awt.Color(0, 51, 102));
        ...
        sifremiUnuttumLabel.setForeground(new java.awt.Color(102, 0, 0));
    ...
    */
    private void girisButtonMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_girisButtonMouseEntered
        ButtonAyarlari.setBgFg(girisButton, Color.black, Color.white);
