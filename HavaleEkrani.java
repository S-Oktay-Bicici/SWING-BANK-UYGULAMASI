...
public class HavaleEkrani extends javax.swing.JFrame implements IDuzenleyici,IBilgiController {
    ...
    public void getEdits() {
        ...
        TextAyarlari.setMaxLimit(gonderilecekMiktarText, 4);
    ...
    private void initComponents() {
        ...
        setTitle("Swing Bank Havale Ekranı");

        havaleEkraniPanel.setBackground(new java.awt.Color(0, 102, 0));

        kullaniciAdiSoyadiLabel.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        kullaniciAdiSoyadiLabel.setForeground(new java.awt.Color(102, 0, 0));
        ...
        limitUyariLabel.setText("Tek seferde 5.000 TL ve altını gönderebilirsiniz.");
        ...
        havaleButton.setBackground(new java.awt.Color(0, 102, 0));
        havaleButton.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        havaleButton.setForeground(new java.awt.Color(102, 0, 0));
        ...
        havaleEkraniPanelLayout.setVerticalGroup(
            ...
            .addGroup(havaleEkraniPanelLayout.createSequentialGroup()
                ...
                .addGroup(havaleEkraniPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(gonderilecekMiktarText, javax.swing.GroupLayout.DEFAULT_SIZE, 40, Short.MAX_VALUE))
                .addGap(18, 18, 18)
                .addGroup(havaleEkraniPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(musteriNoText, javax.swing.GroupLayout.DEFAULT_SIZE, 40, Short.MAX_VALUE))
                .addGap(40, 40, 40)
    ...
    private void gonderilecekMiktarTextKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_gonderilecekMiktarTextKeyReleased
        this.gonderilecekMiktar = TextAyarlari.checkTheTextKeyReleased(gonderilecekMiktarText, 5000);
